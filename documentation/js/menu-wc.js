                ...
                <li class="chapter">
                            ...
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        ...
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-6286d6bec096e9f4f6af6a1bcec9d141"' :
                                            ...
                                            <li class="link">
                                                <a href="components/BlurredSurfaceComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">BlurredSurfaceComponent</a>
                                            </li>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    ...
                                    <ul class="links collapse" ${ isNormalMode ? 'id="directives-links-module-AppModule-6286d6bec096e9f4f6af6a1bcec9d141"' :
                                        ...
                                        <li class="link">
                                            <a href="directives/IntroAnimationDirective.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules">IntroAnimationDirective</a>
                                        </li>
                                        <li class="link">
                                            <a href="directives/TrackBarDirective.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules">TrackBarDirective</a>
                                        </li>
                                    </ul>
                                </li>
                            </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/questionObj.html" data-type="entity-link">questionObj</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
